...
private static class ActionsBar extends JPanel { final StyledButton pass, like, refresh; ActionsBar(){ setOpaque(true); setBackground(Color.WHITE); setPreferredSize(new Dimension(10,180)); setLayout(new BorderLayout());
...
// Center row for Like/Pass buttons
...
pass = StyledButton.outlinePink("Pass ✕");
pass.setPreferredSize(new Dimension(140, 50));
JPanel leftWrap = new JPanel(new FlowLayout(FlowLayout.LEFT, 0, 0));
leftWrap.setOpaque(false);
leftWrap.setBorder(new EmptyBorder(0, 30, 0, 0));
leftWrap.add(pass);
row.add(leftWrap, gbc);
gbc.gridx = 1;
gbc.anchor = GridBagConstraints.EAST;
gbc.weightx = 1;
like = StyledButton.gradient("Like ❤", new Color(0xFF69B4), new Color(0xFF8FAB));
like.setPreferredSize(new Dimension(140, 50));
JPanel rightWrap = new JPanel(new FlowLayout(FlowLayout.RIGHT, 0, 0));
rightWrap.setOpaque(false);
rightWrap.setBorder(new EmptyBorder(0, 0, 0, 30));
rightWrap.add(like);
...
refresh = StyledButton.gradient("🔄 Refresh Candidates", new Color(0x3BB789), new Color(0x45D09E));
refresh.setPreferredSize(new Dimension(240, 50));
bottom.add(refresh);
